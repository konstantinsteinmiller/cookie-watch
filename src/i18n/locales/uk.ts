export default {
  'hints': {
    'tapToMove': 'Утримуйте бік, щоб скрадатися — подвійний дотик для ривка, відпустіть, щоб прикинутися мертвим',
    'keysToMove': 'Утримуйте ◀ ▶, щоб скрадатися — подвійне натискання для ривка, відпустіть, щоб прикинутися мертвим',
    'freeze': 'Завмри! Не рухайся!',
    'run': 'Тікай! Не зупиняйся!'
  },
  'tutorial': {
    'harvestTouch': 'Утримуйте вправо біля печива, щоб відламувати шматки',
    'harvestDesktop': 'Утримуйте ▶ біля печива, щоб відламувати шматки',
    'playDeadTouch': 'Відпустіть, щоб прикинутися мертвим',
    'playDeadDesktop': 'Відпустіть, щоб прикинутися мертвим',
  ...
  'frenzy': {
    'title': 'Ненажерство!',
    'sub': 'Зжери весь десерт, поки не вийшов час!',
    'tap': 'Тисни! Тисни! Тисни!',
    'click': 'Клікай! Клікай! Клікай!',
    'chokeHint': 'Тримай темп — тиснутимеш надто швидко, вдавишся!',
    'choking': 'Вдавився!'
  },
  'review': {
    'title': 'Підсумки рівня',
    'delivery': 'Доставка',
    'greedy': 'Бонус жадібності',
    'closeCall': 'Ледве ухилився',
    'insaneEscape': 'Шалена втеча',
    'daringTotal': 'Підсумок зухвалості',
    'pass': 'Етап пройдено',
    'perfectClear': 'Ідеально!',
    'goldClear': 'Золоте проходження!',
    'toFrenzy': 'З’їж печиво!'
  },
  'ads': {
  ...
  'startSubhint': 'Утримуйте один бік, щоб скрадатися, відпустіть — і миша прикинеться мертвою. Утримуйте в бік печива, щоб відламувати шматки, несіть їх додому — і ЗАВМРІТЬ, коли кіт прокинеться!',
  'powerups': {
    'invuln': 'Невразливий',
  ...
  'result': {
    ...
    'caught': 'Лазер кота випарував тебе!',
    'timeout': 'Час вийшов — украдено замало!'
  },
  'upgrades': {
    'title': 'Покращення',
    ...
    'descriptions': {
      ...
      'calmNerves': 'Більше часу, щоб завмерти після пробудження кота (+0,05 с за рівень).',
      'lightPaws': 'Кіт спить довше — зелене світло довше (+4% за рівень).',
      'extraTime': 'Починайте кожну кухню із запасом часу (+5 с за рівень).',
      'deepHole': 'Здобич провалюється в нору швидше (+12% за рівень).',
      'sixthSense': 'Лазер заряджається довше, тож на ухилення більше часу (+0,15 с за рівень).'
    },
    'secondChance': {
      'name': 'Другий Шанс',
