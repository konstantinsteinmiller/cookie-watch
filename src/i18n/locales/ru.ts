export default {
  'hints': {
    'tapToMove': 'Удерживайте сторону, чтобы красться — двойное касание для рывка, отпустите, чтобы притвориться мёртвым',
    'keysToMove': 'Удерживайте ◀ ▶, чтобы красться — двойное нажатие для рывка, отпустите, чтобы притвориться мёртвым',
    'freeze': 'Замри! Не двигайся!',
    'run': 'Беги! Не останавливайся!'
  },
  'tutorial': {
    'harvestTouch': 'Удерживайте вправо у печенья, чтобы отламывать куски',
    'harvestDesktop': 'Удерживайте ▶ у печенья, чтобы отламывать куски',
    'playDeadTouch': 'Отпустите, чтобы притвориться мёртвым',
    'playDeadDesktop': 'Отпустите, чтобы притвориться мёртвым',
    'avoidCat': 'Не дай коту себя поймать'
  },
  'cat': {
    'asleep': 'Спит',
    'awake': 'Проснулся'
  ...
  'frenzy': {
    'title': 'Обжорство!',
    'sub': 'Сожри весь десерт, пока не вышло время!',
    'tap': 'Жми! Жми! Жми!',
    'click': 'Кликай! Кликай! Кликай!',
    'chokeHint': 'Держи темп — будешь жать слишком быстро, подавишься!',
    'choking': 'Подавился!'
  },
  'review': {
    'title': 'Итоги уровня',
    'delivery': 'Доставка',
    'greedy': 'Бонус жадности',
    'closeCall': 'Едва увернулся',
    'insaneEscape': 'Безумный побег',
    'daringTotal': 'Итог дерзости',
    'pass': 'Этап пройден',
    'perfectClear': 'Идеально!',
    'goldClear': 'Золотое прохождение!',
    'toFrenzy': 'Съешь печенье!'
  },
  'ads': {
  ...
  'startSubhint': 'Удерживайте одну сторону, чтобы красться, отпустите — и мышь притворится мёртвой. Удерживайте в сторону печенья, чтобы отламывать куски, несите их домой — и ЗАМРИТЕ, когда кот проснётся!',
  'powerups': {
    'invuln': 'Неуязвимость',
    'magnet': 'Магнит монет',
  ...
  'result': {
    ...
    'caught': 'Лазер кота испарил тебя!',
    'timeout': 'Время вышло — украдено слишком мало!'
  },
  'upgrades': {
    'title': 'Улучшения',
    ...
    'descriptions': {
      ...
      'calmNerves': 'Больше времени, чтобы замереть после пробуждения кота (+0,05 с за уровень).',
      'lightPaws': 'Кот спит дольше — зелёный свет длиннее (+4% за уровень).',
      'extraTime': 'Начинайте каждую кухню с запасом времени (+5 с за уровень).',
      'deepHole': 'Добыча проваливается в нору быстрее (+12% за уровень).',
      'sixthSense': 'Лазер заряжается дольше, так что на уклонение больше времени (+0,15 с за уровень).'
    },
    'secondChance': {
      'name': 'Второй шанс',
